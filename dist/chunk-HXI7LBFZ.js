...
function ChatHeader({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border-subtle/50 bg-surface-canvas/80 backdrop-blur-xs", children: [
...
function ChatMessageArea({
  ...
  const renderContent = (content) => {
    ...
    return /* @__PURE__ */ jsx3("p", { className: "text-sm text-text-primary whitespace-pre-wrap wrap-break-word", children: content });
  };
...
function PreviewPhaseSection({
  ...
  return /* @__PURE__ */ jsxs4("div", { className: `rounded-lg border ${colors.border} ${colors.bg}`, children: [
    ...
    isExpanded && /* @__PURE__ */ jsx4("div", { className: "px-2 pb-2 space-y-1", children: steps.map((rawStep, i) => {
      const step = rawStep;
...
//# sourceMappingURL=chunk-HXI7LBFZ.js.map