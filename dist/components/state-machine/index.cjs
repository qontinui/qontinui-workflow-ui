...
function StateMachineGraphViewInner({
  ...
  if (states.length > GRAPH_MAX_NODES) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col items-center justify-center h-full gap-3 text-center px-8 text-text-muted", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.LayoutGrid, { className: "size-10 opacity-40" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "text-sm font-medium text-text-primary", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "text-xs max-w-md", children: [
        "Graphs above ",
        GRAPH_MAX_NODES,
        " nodes overwhelm the browser's layout engine. Use the ",
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-brand-primary", children: "State View" }),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "h-full w-full", onDragOver, onDrop, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    import_react6.ReactFlow,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react6.Panel, { position: "bottom-left", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "text-[10px] text-text-muted/70 bg-bg-primary/80 backdrop-blur-xs px-2.5 py-1.5 rounded border border-border-secondary/50 flex items-center gap-2", children: [
        ...
        showShortcuts && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react6.Panel, { position: "bottom-right", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "bg-bg-primary/95 border border-border-secondary rounded-lg p-4 text-xs shadow-lg backdrop-blur-xs min-w-[200px]", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "flex-1 overflow-y-auto", children: selectedTransition ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "p-6 space-y-6", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "flex items-center gap-2 mt-2 text-xs text-text-muted flex-wrap", children: [
          ...
          selectedTransition.exit_states.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "inline-flex items-center rounded-full px-2 py-0.5 text-[10px] border status-error text-red-400 border-red-500/30", children: [
            "Exit:",
            " ",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("div", { className: "absolute bottom-3 left-3 text-[10px] text-text-muted bg-bg-primary/80 backdrop-blur-xs px-2.5 py-1.5 rounded border border-border-secondary/50", children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "flex items-center gap-3", children: [
        ...
        hoveredStateId && /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "absolute top-3 left-3 text-xs bg-bg-primary/95 backdrop-blur-xs px-3 py-2 rounded-lg border border-border-secondary shadow-md", children: [
...
function StateViewPanel({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "flex flex-1 h-full min-w-0", children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "w-72 border-r border-border-secondary bg-bg-primary shrink-0 flex flex-col min-h-0", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "flex-1 min-h-0 p-2", children: filteredStates.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("p", { className: "text-xs text-text-muted text-center py-4", children: "No states match filter." }) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
...
function DiagramTab({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-col h-full w-full", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex-1 min-h-0 overflow-auto p-6 bg-surface-secondary", children: [
      unavailableReason && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "flex items-center justify-center h-full text-text-muted text-sm text-center px-6", children: unavailableReason }),
      !unavailableReason && isLoading && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-center justify-center h-full text-text-muted gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_lucide_react10.Loader2, { className: "size-4 animate-spin" }),
        "Loading diagram\u2026"
      ] }),
      !unavailableReason && !isLoading && importError && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "max-w-xl mx-auto p-4 border border-border-primary rounded-md bg-surface-primary text-sm text-text-primary", children: [
      ...
      !unavailableReason && !isLoading && !importError && !hasSource && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: "flex items-center justify-center h-full text-text-muted", children: "No diagram available" }),
      !unavailableReason && !isLoading && !importError && hasSource && renderError && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: "max-w-xl mx-auto p-4 border border-border-primary rounded-md bg-surface-primary text-sm", children: [
