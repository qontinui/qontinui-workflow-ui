...
function ChunkedGraphViewInner(props) {
  ...
  const decomposeCache = useRef2(/* @__PURE__ */ new Map());
  useEffect2(() => {
    decomposeCache.current.clear();
  }, [states, transitions, effectiveInitialStateId]);
  const getDecomposition = useCallback2(
    (c) => {
  ...
  const pathForState = useCallback2(
    (stateId) => {
  ...
  const popToDepth = useCallback2((depth) => {
    setViewMode((prev) => {
  ...
  const popOneLevel = useCallback2(() => {
    setViewMode((prev) => {
      if (prev.kind !== "drilled") return prev;
    ...
    return /* @__PURE__ */ jsxs5(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx5("div", { className: "flex-1 min-h-0", children: body })
        ]
      }
    );
  }
...
function Breadcrumb({
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "flex items-center gap-2 px-3 py-2 border-b border-border-secondary bg-bg-secondary/40 shrink-0", children: [
    ...
    /* @__PURE__ */ jsxs5("div", { className: "text-xs text-text-muted flex items-center gap-1.5 flex-wrap", children: [
      /* @__PURE__ */ jsx5(
        "button",
        {
          type: "button",
      ...
      visible.map((seg, i) => {
        if (seg.kind === "ellipsis") {
          return /* @__PURE__ */ jsxs5("span", { className: "flex items-center gap-1.5", children: [
