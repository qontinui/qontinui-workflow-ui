...
function ChatHeader({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border-subtle/50 bg-surface-canvas/80 backdrop-blur-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-3", children: [
      ...
      isEditing ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center gap-1.5", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "input",
          {
            ref: inputRef,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StateBadge, { state: sessionState }),
      isRunnerConnected !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "flex items-center gap-1 text-[10px]", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "span",
          {
...
function ChatInput({
  ...
  const [includeUIBridge, setIncludeUIBridge] = (0, import_react2.useState)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "border-t border-border-subtle/50 p-4", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between mb-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: `text-xs ${stateColor}`, children: stateLabel }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "flex items-center gap-2", children: showGenerateWorkflow && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "button",
          {
            ...
            children: [
              isGeneratingWorkflow ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "svg",
                {
                ...
                "svg",
                {
                  ...
                  stroke: "currentColor",
                  strokeWidth: "2",
                  children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z" })
                }
              ),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-end gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "textarea",
        {
          ref: textareaRef,
      ...
      canInterrupt ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "button",
        {
          onClick: onInterrupt,
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
            "svg",
            {
              ...
              viewBox: "0 0 24 24",
              fill: "currentColor",
              children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("rect", { x: "3", y: "3", width: "18", height: "18", rx: "2" })
            }
          )
        }
      ) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "button",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
            "svg",
            {
              ...
              strokeLinejoin: "round",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "m22 2-7 20-4-9-9-4Z" }),
                /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: "M22 2 11 13" })
              ]
            }
          )
        }
...
function ChatMessageArea({
  ...
  const [autoScroll, setAutoScroll] = (0, import_react3.useState)(true);
  const prevLenRef = (0, import_react3.useRef)(0);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      children: [
        messages.length === 0 && !streamingContent && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex flex-col items-center justify-center h-full text-text-muted", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-sm", children: "Start a conversation with AI" }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "text-xs mt-1 opacity-60", children: "Discuss features, plan workflows, then generate them" })
        ] }),
        ...
        isStreaming && streamingContent && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex gap-3 items-start", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "max-w-[85%]", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "max-w-none text-sm", children: renderContent(streamingContent) }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "inline-block w-2 h-4 bg-purple-400 animate-pulse ml-0.5" })
              ]
            }
          ) })
        ] }),
        isStreaming && !streamingContent && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex gap-3 items-start", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            "div",
            {
              className: "rounded-lg px-4 py-3 border border-border-subtle/30",
              style: { background: "color-mix(in srgb, var(--qontinui-surface-raised, #1e1e22) 30%, var(--qontinui-surface-canvas, #111115))" },
              children: toolActivity ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { className: "size-3.5 text-purple-400 animate-spin", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 2v4" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 18v4" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m4.93 4.93 2.83 2.83" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m16.24 16.24 2.83 2.83" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M2 12h4" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M18 12h4" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m4.93 19.07 2.83-2.83" }),
                  /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m16.24 7.76 2.83-2.83" })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xs text-purple-300/80", children: toolActivity })
              ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "w-1.5 h-1.5 rounded-full bg-purple-400 animate-bounce [animation-delay:0ms]" }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "w-1.5 h-1.5 rounded-full bg-purple-400 animate-bounce [animation-delay:150ms]" }),
                /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "w-1.5 h-1.5 rounded-full bg-purple-400 animate-bounce [animation-delay:300ms]" })
              ] })
            }
          )
        ] }),
        isStreaming && streamingContent && toolActivity && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex gap-3 items-center ml-10", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-2 px-3 py-1.5 rounded-md bg-surface-raised/20", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("svg", { className: "size-3 text-purple-400/60 animate-spin", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 2v4" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 18v4" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m4.93 4.93 2.83 2.83" }),
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m16.24 16.24 2.83 2.83" }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xs text-text-muted", children: toolActivity })
        ] }) }),
        !autoScroll && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "button",
          {
...
function UserIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "svg",
    {
      ...
      strokeWidth: "2",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2" }),
...
function MessageBubble({
  ...
  if (message.role === "system") {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "flex justify-center py-1", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-surface-raised/40 border border-border-subtle/20", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
        "svg",
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-xs text-text-muted/80", children: message.content })
    ] }) });
  }
  if (message.role === "user") {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex gap-3 items-start justify-end", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "max-w-[85%]", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "div",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "text-sm text-text-primary", children: renderContent(message.content) })
          }
        ),
        formattedTime && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "text-[10px] text-text-muted/60 mt-1 text-right", children: formattedTime })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "shrink-0 w-7 h-7 rounded-full bg-brand-primary/20 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(UserIcon, {}) })
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "group/msg flex gap-3 items-start", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "shrink-0 w-7 h-7 rounded-full bg-purple-900/50 flex items-center justify-center", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(AiBotIcon, {}) }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "max-w-[85%]", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
        "div",
        {
          className: "rounded-lg px-4 py-3 border border-border-subtle/30",
          style: { background: "color-mix(in srgb, var(--qontinui-surface-raised, #1e1e22) 30%, var(--qontinui-surface-canvas, #111115))" },
          children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "max-w-none text-sm", children: renderContent(message.content) })
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "flex items-center gap-2 mt-1", children: [
        formattedTime && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "text-[10px] text-text-muted/60", children: formattedTime }),
        onCreateWorkflow && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("svg", { className: "size-3.5", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 3l1.912 5.813a2 2 0 0 0 1.275 1.275L21 12l-5.813 1.912a2 2 0 0 0-1.275 1.275L12 21l-1.912-5.813a2 2 0 0 0-1.275-1.275L3 12l5.813-1.912a2 2 0 0 0 1.275-1.275L12 3z" }) }),
              "Create Workflow"
            ]
          }
        )
...
function WorkflowPreviewPanel({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex flex-col h-full border-l border-border-subtle/50 bg-surface-canvas/95", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center justify-between px-4 py-3 border-b border-border-subtle/50", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { className: "text-sm font-semibold text-text-primary", children: "Generated Workflow" }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex-1 overflow-y-auto p-4", children: [
      isLoading && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex flex-col items-center justify-center h-48 text-text-muted", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "svg",
          {
            ...
            stroke: "currentColor",
            strokeWidth: "2",
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M21 12a9 9 0 1 1-6.219-8.56" })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-sm", children: "Generating workflow..." }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-xs mt-1 opacity-60", children: "This may take a minute" })
      ] }),
      error && !isLoading && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex flex-col items-center justify-center h-48 text-red-400", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-sm font-medium", children: "Generation Failed" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-xs mt-1 opacity-60 text-center max-w-[250px]", children: error })
      ] }),
      workflow && !isLoading && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "space-y-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mb-4", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h4", { className: "text-sm font-medium text-text-primary", children: workflow.name }),
          workflow.description && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-xs text-text-muted mt-1", children: workflow.description }),
          workflow.tags && workflow.tags.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex gap-1 mt-2 flex-wrap", children: workflow.tags.map((tag) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "span",
            {
    ...
    workflow && !isLoading && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "border-t border-border-subtle/50 p-4 space-y-2", children: [
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                "svg",
                {
                  ...
                  viewBox: "0 0 24 24",
                  fill: "currentColor",
                  children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("polygon", { points: "5 3 19 12 5 21 5 3" })
                }
              ),
              "Execute"
            ]
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                "svg",
                {
                  ...
                  strokeWidth: "2",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M21 12a9 9 0 0 0-9-9 9.75 9.75 0 0 0-6.74 2.74L3 8" }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M3 3v5h5" }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M3 12a9 9 0 0 0 9 9 9.75 9.75 0 0 0 6.74-2.74L21 16" }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M16 16h5v5" })
                  ]
                }
              ),
              "Regenerate"
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                "svg",
                {
                  ...
                  strokeWidth: "2",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M19 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11l5 5v11a2 2 0 0 1-2 2z" }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("polyline", { points: "17 21 17 13 7 13 7 21" }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("polyline", { points: "7 3 7 8 15 8" })
                  ]
                }
              ),
              "Save to Library"
...
function PreviewPhaseSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: `rounded-lg border ${colors.border} ${colors.bg}`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "button",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "svg",
            {
              ...
              stroke: "currentColor",
              strokeWidth: "2",
              children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "m9 18 6-6-6-6" })
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            "span",
    ...
    isExpanded && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "px-2 pb-2 space-y-1", children: steps.map((step, i) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "div",
      {
        className: "flex items-center gap-2 px-2 py-1.5 rounded-md hover:bg-black/20",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(StepTypeIcon, { type: step.type }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "text-xs text-zinc-200 truncate", children: step.name }) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
            "svg",
            {
...
function StepTypeIcon({ type }) {
  if (type === "command") {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "svg",
      {
        ...
        strokeWidth: "2",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("polyline", { points: "4 17 10 11 4 5" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("line", { x1: "12", x2: "20", y1: "19", y2: "19" })
        ]
      }
    );
  }
  if (type === "ui_bridge") {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      "svg",
      {
        ...
        strokeWidth: "2",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("rect", { width: "20", height: "14", x: "2", y: "3", rx: "2" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("line", { x1: "8", x2: "16", y1: "21", y2: "21" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("line", { x1: "12", x2: "12", y1: "17", y2: "21" })
        ]
      }
    );
  }
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "svg",
    {
      ...
      strokeWidth: "2",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M12 8V4H8" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("rect", { width: "16", height: "12", x: "4", y: "8", rx: "2" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M2 14h2" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M20 14h2" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M15 13v2" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("path", { d: "M9 13v2" })
      ]
    }
  );
}
